...
<cfLuceeConfiguration salt="E95D1E74-C551-40CF-8A6443630D0C2286" version="4.5">
...
<charset>
<cache>
							<connection class="lucee.runtime.cache.eh.EHCache" custom="timeToIdleSeconds=86400&amp;maxelementsinmemory=10000&amp;maxelementsondisk=10000000&amp;diskpersistent=true&amp;timeToLiveSeconds=86400&amp;overflowtodisk=true&amp;memo" name="jira2623" read-only="false" storage="true"/>
</cache>
</charset>
<cache>
							<connection class="lucee.runtime.cache.eh.EHCache" custom="timeToIdleSeconds=86400&amp;maxelementsinmemory=10000&amp;maxelementsondisk=10000000&amp;diskpersistent=true&amp;timeToLiveSeconds=86400&amp;overflowtodisk=true&amp;memo" name="jira2623" read-only="false" storage="true"/>
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="415" blob="false" class="org.h2.Driver" clob="false" connectionLimit="-1" connectionTimeout="120" custom="" database="lucee-db" dsn="jdbc:h2:./temp/h2dbs/lucee-db/lucee-db" host="127.0.0.1" name="lucee_mirror" password="" port="3306" username="sa">
<cache>
							<connection class="lucee.runtime.cache.eh.EHCache" custom="timeToIdleSeconds=86400&amp;maxelementsinmemory=10000&amp;maxelementsondisk=10000000&amp;diskpersistent=true&amp;timeToLiveSeconds=86400&amp;overflowtodisk=true&amp;memo" name="jira2623" read-only="false" storage="true"/>
</cache>
</data-source>
<data-source allow="415" blob="false" class="org.h2.Driver" clob="false" connectionLimit="-1" connectionTimeout="120" custom="" database="lucee-db" dsn="jdbc:mysql://127.0.0.1:3306/luceetest" host="127.0.0.1" name="mysql" password="cfw3bus3r" port="3306" username="luceetest"/>
<data-source allow="415" blob="false" class="org.h2.Driver" clob="false" connectionLimit="-1" connectionTimeout="120" custom="" database="lucee-db" dsn="jdbc:postgresql://127.0.0.1:5432/luceetest" host="127.0.0.1" name="postgre" password="cfw3bus3r" port="3306" username="luceetest"/>
</data-sources>
...
<cache>
	...
	-->
	<scope client-directory="{lucee-web}/client-scope/" client-directory-max-size="100mb" session-type="cfml"/>
...
<cache>
	...
	<mapping archive="" physical="../../../../../home/valliant/cfdistro/ext/mappings/org.coldbox/testbox/1.1.0/" primary="physical" readonly="true" trusted="false" virtual="/testbox"/>
<mapping archive="" physical="../../../../../home/valliant/cfdistro/ext/mappings/org.coldbox/testbox/1.1.0/system/testing/compat/" primary="physical" readonly="true" trusted="false" virtual="/mxunit"/>
<mapping archive="" physical="../../../tests/" primary="physical" readonly="true" trusted="false" virtual="/lucee-tests"/>
<mapping archive="" physical="../../../tests/testcases/" primary="physical" readonly="true" trusted="false" virtual="/testcases"/>
<mapping archive="" physical="../../../tests/testcases/" primary="physical" readonly="true" trusted="false" virtual="/physical"/>
</mappings>
